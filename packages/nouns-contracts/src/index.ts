...
export { default as NounsDAOABI } from '../abi/contracts/governance/NounsDAOLogicV2.sol/NounsDAOLogicV2.json';
...
export { NounsDaoLogicV2__factory as NounsDaoLogicV2Factory } from '../typechain/factories/NounsDaoLogicV2__factory';
